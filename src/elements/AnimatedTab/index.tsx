...
export default class AnimatedTab extends Component<IProps, IState> {
  ...
  constructor(props: IProps) {
    ...
    this.state = {
      ...
      translateXTabThree: new Animated.Value(widthScreen),
      translateY: -1000,
    };
  }
  ...
  render() {
    ...
    const onPressTab3 = () => {
      this.props.onPressTab3 && this.props.onPressTab3();
    ...
    const textTab3Style =
      active === 2 ? { color: colors.white } : { color: colors.grey3 };
    ...
    return (
      <View style={styles.container}>
        <View style={styles.tabView}>
          ...
          <TouchableOpacity
            style={styles.tabStyle}
            onLayout={onLayOutTab3}
            onPress={onPressTab3}
          >
            <Text style={[styles.title, textTab3Style]}>
